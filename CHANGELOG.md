...
### Tests
- Новые файлы: `tests/resources/pipeline-state-freshness.test.mjs` (5), `tests/health/publisher-lazy-state-dir.test.mjs` (4), `tests/lib/workflow-docs.test.mjs` (6), `tests/health/sweep.test.mjs` (7).
...
- Полный прогон: 98 файлов, 1567 passed, 30 skipped, 4 todo, 0 failed.
...
tests/health/service.test.mjs tests/health/sweep.test.mjs` (49 проверок): возврат
чтения истории вместо обхода валит 6, снятие сортировки по времени — 2, снятие
защиты вокруг каждого детектора — 1.
